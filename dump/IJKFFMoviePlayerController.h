...
@class IJKFFMonitor, IJKFFMoviePlayerMessagePool, IJKHLSIOContext, IJKIOContext, IJKNotificationManager, IJKSDLGLView, IJKSDLHudViewController, NSString, NSTimer, UIView;
...
@interface IJKFFMoviePlayerController : NSObject <IJKMediaPlayback>
{
    ...
    double _fpsInMeta;
    IJKHLSIOContext *_hlsContext;
    IJKIOContext *_ioContext;
...
@property(retain, nonatomic) IJKIOContext *ioContext; // @synthesize ioContext=_ioContext;
@property(retain, nonatomic) IJKHLSIOContext *hlsContext; // @synthesize hlsContext=_hlsContext;
@property(readonly, nonatomic) double fpsInMeta; // @synthesize fpsInMeta=_fpsInMeta;
@property(readonly, nonatomic) int isVideoSync; // @synthesize isVideoSync=_isVideoSync;
@property(readonly, nonatomic) int isAudioSync; // @synthesize isAudioSync=_isAudioSync;
@property(readonly, nonatomic) int isSeekBuffering; // @synthesize isSeekBuffering=_isSeekBuffering;
...
- (void)dealloc;
- (id)initWithMoreContentString:(id)arg1 withOptions:(id)arg2 withGLView:(id)arg3;
- (id)initWithMoreContent:(id)arg1 withOptions:(id)arg2 withGLView:(id)arg3;
