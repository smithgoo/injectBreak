...
@interface GCDWebServerRequest : NSObject <GCDWebServerBodyWriter>
{
    ...
    _Bool _acceptsGzipContentEncoding;
    _Bool _usesChunkedTransferEncoding;
    NSString *_method;
    NSURL *_URL;
...
@property(readonly, nonatomic) _Bool usesChunkedTransferEncoding; // @synthesize usesChunkedTransferEncoding=_usesChunkedTransferEncoding;
...
@property(readonly, nonatomic) _Bool acceptsGzipContentEncoding; // @synthesize acceptsGzipContentEncoding=_acceptsGzipContentEncoding;
