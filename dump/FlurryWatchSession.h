...
@interface FlurryWatchSession : NSObject <FlurryDataSenderDelegate, FlurryWatchConnectivityDelegate, FlurryLocationUtilObserver>
{
...
- (void).cxx_destruct;
- (void)setWatchLongitude:(double)arg1 latitude:(double)arg2 accuracy:(double)arg3;
